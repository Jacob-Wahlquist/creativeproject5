...
export function setupPipes() {
    document.doctypeElement.style.setProperty("--pipe-width", PIPE_WIDTH)
    document.doctypeElement.style.setProperty("--hole-height", HOLE_HEIGHT)
...
function createPipe() {
    ...
    pipeElem.style.setProperty("--hole-top", randomNumberBetween(HOLE_HEIGHT * 1.5, window.innerHeight - HOLE_HEIGHT * 1.5))
    const pipe = {
        get left() {
